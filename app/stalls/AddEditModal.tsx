...
// Types
import type { LocationTypes, SectionTypes, StallTypes } from '@/types'
  ...
  const handleCreate = async (formdata: StallTypes) => {
    try {
      const newData = {
        ...
        has_electricity_bill: formdata.has_electricity_bill,
        status: 'Active',
            ...
            <form
              ...
              {!saving ? (
                <>
                  ...
                  <div className="app__form_field_container">
                    <div className="w-full">
                      <div className="app__label_standard">Monthly Rent</div>
                      <div>
                        <input
                  ...
                  <div className="app__form_field_container">
                    <div className="w-full">
                      ...
                      <div>
                        <input
                          {...register('occupancy_fee', { required: true })}
                          type="number"
                          className="app__select_standard"
                        />
                        {errors.occupancy_fee && (
                          <div className="app__error_message">
                            Occupancy Fee is required
                          </div>
                        )}
                      </div>
                    </div>
                  ...
                  <div className="app__form_field_container">
                    <div className="w-full">
                      ...
                      <div>
                        ...
                        {errors.occupancy_renewal_period && (
                          <div className="app__error_message">
                            Occupancy Fee Renewal Period is required
                          </div>
                        )}
                      </div>
                    </div>
                  ...
                  <div className="app__form_field_container">
                    <div className="w-full">
                      <div className="app__label_standard">
                        Has Monthly Electric Bill?
                      </div>
                      <div>
                        <select
                          {...register('has_electricity_bill', {
                            required: true,
                          })}
                          className="app__select_standard">
